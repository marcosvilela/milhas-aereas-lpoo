...
public class TesteRepositorioDeClientesIO {
	...
	public static void main(String[] args) {
		...
		try{
			...
			rep.adicionar(newClient);
			rep.adicionar(newClient2);
			rep.adicionar(newClient3);

			// TESTANDO O BUSCAR.
			if(rep.buscar(new CPF("12345678900")) == null){
				...
				System.out.println(rep.buscar(new CPF("12345678900")));
			};
